<?php
    ...
    try {
        $product1 = new Cibo('Cibo per cani', 10.99, $dog, 'cibo', 'img/img1.jpeg');
        $product1->setDiscount(10);
        $shop->addProduct($product1);

        $product2 = new Gioco('Gioco per gatti', 5.99, $cat, 'gioco', 'img/img2.jpeg');
        $product2->setDiscount(15);
        $shop->addProduct($product2);

        $product3 = new Cuccia('Cuccia per cani', 49.99, $dog, 'cuccia', 'img/img3.jpeg');
